...
reservation_1 = Reservation.create(id: 1, status: 'confirmed', screening_id: screening_1.id,
                                   ticket_desk_id: ticket_desk_1.id, client_id: client_1.id)
reservation_2 = Reservation.create(id: 2, status: 'confirmed', screening_id: screening_1.id,
                                   ticket_desk_id: ticket_desk_1.id, client_id: client_2.id)
reservation_3 = Reservation.create(id: 3, status: 'paid', screening_id: screening_1.id,
